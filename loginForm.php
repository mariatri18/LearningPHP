                        ...
                        <div class="card-body p-5 shadow-5 text-center">
                            ...
                            <form action="insert.php" method="post">
                                ...
                                <div class="form-outline mb-4" hidden>
                                    ...
                                    <label class="form-label" for="lessonID">First Name</label>
                                </div>
                                <div class="form-outline mb-4" hidden>
                                    <input type="comments" name="comments" id="comments" class="form-control" />
                                    <label class="form-label" for="comments">First Name</label>
                                </div>
                                <!-- Email input -->
